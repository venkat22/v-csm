...
```bash
git clone [https://github.com/your-org/cs-ai-bot.git](https://github.com/your-org/cs-ai-bot.git)
cd cs-ai-bot
...
```env
REACT_APP_API_URL=[https://your-api-gateway-url.com/prod](https://your-api-gateway-url.com/prod)
...
1. **Ingestion:** Help center articles are chunked, converted into embeddings via OpenAI `text-embedding-3-small`, and stored in **AWS OpenSearch**.
2. **Retrieval:** When a customer asks a question, the system searches OpenSearch for the top 3 most relevant text segments.
3. **Generation:** The segments + the user question are sent to **GPT-4o** with a system prompt: *"Only use the provided context to answer. If the answer isn't there, suggest contacting a human."*
...
### Pro-Tip for Sharing:
If you are presenting this to a **manager or client**, I recommend adding a "Screenshots" section right under the **Overview**. You can simply drag and drop an image of your React UI into the README file on GitHub to generate the link!

**Would you like me to help you write the "System Prompt" that controls how the bot speaks to customers?**
